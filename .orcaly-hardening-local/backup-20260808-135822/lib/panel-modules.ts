...
const modules: Array<Omit<PanelModule, 'icon'>> = [
  {
    ...
    emoji: '🏠',
    label: 'Visão geral',
    description: 'Indicadores, atividade recente e atalhos da operação.',
    href: '/painel/inicio',
    group: 'principal',
  ...
  },
  {
    ...
    description: 'Gerencie produtos, serviços, fotos, preços, estoque e disponibilidade da sua vitrine.',
  ...
  },
  {
    id: 'catalogo',
    emoji: '🛒',
    label: 'Vitrine comercial legada',
    description: 'Rota mantida apenas para compatibilidade; a experiência principal agora fica em Minha Vitrine.',
    href: '/painel/catalogo',
    fallbackHref: '/painel/site',
  ...
  // Presença digital e sistema
  {
    ...
    emoji: '🌐',
    label: 'Minha Vitrine',
    description: 'Edite o site, catálogo, cardápio, aparência e experiência de compra em um só lugar.',
    href: '/painel/site',
    group: 'principal',
    segments: allSegments,
    status: 'active',
