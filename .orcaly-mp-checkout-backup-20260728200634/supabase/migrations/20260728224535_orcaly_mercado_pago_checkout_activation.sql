...
-- Ativa o checkout transparente após OAuth e contabiliza cupom uma única vez.
...
revoke all on function public.consume_marketplace_coupon(uuid, uuid)
  from public, anon, authenticated;
grant execute on function public.consume_marketplace_coupon(uuid, uuid)
  to service_role;
