...
> = {
  basico: {
    ...
    preco: 'R$ 49/mÃªs',
    valor: 49,
    descricao: 'CatÃ¡logo, pÃ¡gina pÃºblica e recebimento de pedidos.',
  },
  profissional: {
    nome: 'Profissional',
    preco: 'R$ 99/mÃªs',
    valor: 99,
    descricao: 'GestÃ£o completa com pagamentos, sinal e organizaÃ§Ã£o de pedidos.',
  },
  premium: {
    nome: 'Premium',
    preco: 'R$ 199/mÃªs',
    valor: 199,
    descricao: 'Mais recursos, automaÃ§Ãµes e personalizaÃ§Ã£o para operaÃ§Ãµes maiores.',
  },
}
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[.9fr_1.1fr] lg:items-start">
          <aside className="rounded-[2rem] border border-blue-50 bg-white p-6 shadow-xl shadow-blue-950/5">
            ...
            <h1 className="mt-3 text-4xl font-black leading-tight text-[#071b3a] sm:text-5xl">
              {ativa ? 'Seu plano estÃ¡ ativo' : 'Pagamento necessÃ¡rio'}
            </h1>

            <p className="mt-4 text-lg leading-8 text-slate-600">
              {ativa
                ? 'Sua empresa estÃ¡ liberada para usar o painel do OrÃ§aly.'
                : 'Para acessar o painel, Ã© necessÃ¡rio concluir o pagamento do plano escolhido.'}
            </p>
            ...
            <div className="mt-6 rounded-3xl border border-blue-100 bg-blue-50 p-5">
              ...
              <div className="mt-4 grid gap-2 text-sm font-bold text-slate-600">
                ...
                <p>
                  Plano:{' '}
                  {empresa?.assinatura_plano || empresa?.plano || 'nÃ£o definido'}
                </p>
                <p>
                  Expira em:{' '}
