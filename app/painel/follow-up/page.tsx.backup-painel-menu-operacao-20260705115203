...
const futureActions = [
  "Ver orçamentos aguardando resposta",
  "Chamar cliente no WhatsApp",
  "Agendar retorno",
  "Marcar como perdido",
  "Ver oportunidades por valor"
]
...
export default function Page() {
  return (
    <PanelModuleShell
      ...
      description="Acompanhe clientes parados, propostas aguardando resposta e oportunidades que precisam de retorno."
      status="Em preparação"
      actions={[
        { label: 'Voltar ao painel', href: '/painel' },
        { label: 'Módulo relacionado', href: "/painel/crm", primary: true },
      ]}
      metrics={[
