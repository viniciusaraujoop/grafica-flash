...
try {
    Write-Host ""
    Write-Host "ORCALY - HOME MOBILE RESPONSIVE V2" -ForegroundColor Cyan
    ...
    Step "Resumo"
    Write-Host ""
    Write-Host "HOME MOBILE RESPONSIVE V2 APLICADA" -ForegroundColor Green
    Write-Host ""
    Write-Host "Ajustado:"
