...
$TranscriptPath = Join-Path $ReportDir "hardening-continuacao-v5-$Stamp.txt"
...
Write-Step "Scanner de credenciais corrigido - historico Git"
    ...
    Write-Host "ORCALY_HARDENING_V5_READY=1" -ForegroundColor Green
}
catch {
    Write-Host ""
    Write-Host "ORCALY_HARDENING_V5_FAILED=1" -ForegroundColor Red
