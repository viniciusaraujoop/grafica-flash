...
New-Item -ItemType Directory -Force "app\painel" | Out-Null

Set-Content -Path "app\painel\layout.tsx" -Encoding UTF8 -Value @'
'use client'
...
Write-Host "Proteção de assinatura criada em app/painel/layout.tsx" -ForegroundColor Green
