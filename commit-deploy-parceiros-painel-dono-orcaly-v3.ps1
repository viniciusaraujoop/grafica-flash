...
Write-Section "ORCALY - COMMIT E DEPLOY DO PROGRAMA DE PARCEIROS - V3"
...
$Checks = @(
    ...
    @{
        File = "app/parceiros/layout.tsx"
        Markers = @(
            $AffiliateVisualMarker,
            "Orçaly Parceiros",
            "partnerFadeUp"
        )
    },
    ...
    @{
        File = "app/parceiros/login/page.tsx"
        Markers = @(
            $AffiliateVisualMarker,
            "Criar conta",
            "Entrar"
    ...
    @{
        File = "app/parceiros/cadastro/page.tsx"
        Markers = @(
            $AffiliateVisualMarker,
            "Criar conta",
            "Termos de Uso",
