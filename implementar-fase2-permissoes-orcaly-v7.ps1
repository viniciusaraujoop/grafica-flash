...
$BackupRoot = Join-Path $ProjectRoot (".orcaly-backups\fase2-merge-v7-" + (Get-Date -Format "yyyyMMdd-HHmmss"))
...
try {
    Write-Host ""
    Write-Host "ORCALY - FASE 2 - MERGE OWNER/SUPPORT + PROSPECTOR V7" -ForegroundColor Cyan
