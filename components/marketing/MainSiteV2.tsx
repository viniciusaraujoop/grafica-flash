    ...
    <main className="min-h-screen overflow-x-clip bg-white text-[#0b2347] [color-scheme:light]">
      ...
      <section id="contato" className="marketing-section bg-[#f4f7fb] px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_30px_80px_rgba(10,43,82,.09)] lg:grid-cols-[1.08fr_.92fr]">
          <div className="bg-[#071b3a] p-6 text-white sm:p-9 lg:p-10"><p className="text-xs font-semibold uppercase tracking-[.16em] text-cyan-200">Fale com a gente</p><h2 className="mt-3 text-3xl font-semibold leading-[1.04] tracking-[-.05em] sm:text-5xl">Quer entender como o Orçaly encaixa na sua empresa?</h2><p className="mt-4 max-w-2xl text-sm leading-7 text-white/65">Estamos por aqui para tirar dúvidas e ajudar você a encontrar a melhor forma de usar o Orçaly no seu negócio.</p><a href="mailto:orcalybr@gmail.com?subject=Quero%20conhecer%20o%20Or%C3%A7aly" className="mt-7 inline-flex rounded-xl bg-white px-4 py-3 text-sm font-semibold text-[#0b3b78]">orcalybr@gmail.com</a></div>
